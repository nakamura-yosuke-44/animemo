...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "kodoguru_production"
  ...
  config.action_mailer.default_url_options = { protocol: 'https', host: 'yn-kodoguru-app-1-11b60cbd9d5f.herokuapp.com' }
